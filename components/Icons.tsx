...
export const PremiumIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6.5 3.5l4 4M18.5 3.5l-4 4M12 22v-3M22 12h-3M5 12H2M12 2L9.5 7 5 7.5 8 11l-1 4.5L12 13l5 2.5-1-4.5 3-3.5-4.5-.5L12 2z" />
    </svg>
);
